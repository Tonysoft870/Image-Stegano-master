 ...
 * @author user
 */
public class ExtractSobelTxt extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ExtractSobelTxt
     */
    public ExtractSobelTxt() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Sobel  EdgeText Decoding");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExtractSobelTxt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExtractSobelTxt().setVisible(true);
            }
        });
    }
